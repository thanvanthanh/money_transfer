...
#ifndef MONEY_TRANSFER_SWIFT_H
#define MONEY_TRANSFER_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="money_transfer",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class NSApplication;
SWIFT_CLASS("_TtC14money_transfer11AppDelegate")
...
SWIFT_CLASS("_TtC14money_transfer17MainFlutterWindow")
